...
| 頁面 | 內容 |
|------|------|
| **監控首頁** | 連線狀態、溫度、圓盤狀態、蓋子狀態、霍爾感測、補藥提示 |
| **手動控制** | 馬達控制、風扇/LED、音效測試、Demo模式 |
| **設定** | 鬧鐘設定（最多5組，自動排序）、目標藥杯數、出藥模式A/B |
| **補藥模式** | 進入/結束補藥模式、補藥引導、補藥完成確認 |
| **取藥紀錄** | 歷史取藥記錄查詢、匯出 .txt |
